(self["webpackChunkace_playground"] = self["webpackChunkace_playground"] || []).push([[7784],{
...
var identifier, LiveScriptMode, keywordend, stringfill;
  ...
  exports.Mode = LiveScriptMode = (function(superclass){
    ...
    function LiveScriptMode(){
      var that;
      this.$tokenizer = new (__webpack_require__(34856).Tokenizer)(LiveScriptMode.Rules);
      if (that = __webpack_require__(27884)) {
        this.$outdent = new that.MatchingBraceOutdent;
      }
      this.$id = "ace/mode/livescript";
      this.$behaviour = new ((__webpack_require__(91680)/* .CstyleBehaviour */ .G))();
    }
  ...
  }((__webpack_require__(83736).Mode)));
...
//# sourceMappingURL=bundle.7784.js.map